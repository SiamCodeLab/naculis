...
class ForgotPasswordOtpController extends GetxController {
  ...
  void onInit() {
    ...
    url = Uri.parse(ApiEndpoints.forgetPasswordOtp); // Forgot password endpoint
  }
  ...
  Future<void> verifyOtp(String otp) async {
    ...
    print("Sending Forgot Password OTP: ${email.value} | OTP: $otp");
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        Get.offAllNamed(RouteName.newPasswordSet,
